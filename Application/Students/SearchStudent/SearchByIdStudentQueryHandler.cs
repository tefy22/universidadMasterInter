...
{
    internal sealed class SearchByIdStudentQueryHandler : ICommandHandler<SearchByIdStudentQuery, StudentDto>
    {
        private readonly IStudentRepository _studentRepository;

        public SearchByIdStudentQueryHandler(IStudentRepository studentRepository)
        {
            _studentRepository = studentRepository;
        }

        public async Task<Result<StudentDto>> Handle(SearchByIdStudentQuery request, CancellationToken cancellationToken)
        {
            try
            {
